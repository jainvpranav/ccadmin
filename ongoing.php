<?php
   ...
   if(!isset($_SESSION['aid'])){
    ...
    $sql="SELECT * from notifications WHERE passad=1 AND drvad=1 AND endtour=0;";
...
<html lang="en">
  ...
  <nav class="navbar navbar-fixed-top w-100 navbar-custom navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="pass.php">Passengers</a>
          </li>
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="drv.php">Drivers</a>
          </li>
          <li class="nav-item">
    ...
    <main>
      <div class="box">
        <div class="inner-box ">
          <h2 style="text-align: center;">Ongoing Tour</h2>
            <table class="table table-light table-borderless table-hover table-responsive-sm">
                    ...
                    <tbody>
                      <?php
                          ...
                          $passph=$c6['usrphone'];
                          $_SESSION['nid']=$nid;
                          $a2 = "SELECT pricekm FROM drvinfo WHERE drvid=$drv_id;";
                          $b2 = mysqli_query($conn,$a2);
                          $c2=$b2->fetch_assoc();
                          $pricekm=intval($c2['pricekm']);
