          ...
          <h2 style="text-align: center;">All trips</h2>
            <table class="table table-light table-borderless table-hover table-responsive-sm">
                    <thead class="table-dark">
                      <tr>
                        <th scope="col">#</th>
                        <th scope="col">drvid</th>
                        <th scope="col">drvname</th>
                        <th scope="col">drvemail</th>
                        <th scope="col">drvphone</th>
                        <th scope="col">drvlicense</th>
                        <th scope="col">drvaadhar</th>
                    ...
                    <tbody>
                      <?php
                          ...
                          $email= $row->drvemail;
                          $ph= $row->drvphone;
                          $license= $row->drvlicense;
                          $aadhar= $row->drvaadhar;
                          $cartype= $row->cartype;
                          $pricekm= $row->pricekm;
                          $vacancy= $row->vacancy;
                        ?>
